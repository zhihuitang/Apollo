...
class QDatePicker: UIView, UIGestureRecognizerDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    private lazy var pickerView: UIPickerView = {
        let pickerView = UIPickerView(frame: CGRect(x: 0, y: 0, width: self.yearL.width, height: self.yearL.height))
...
extension QDatePicker: MFMailComposeViewControllerDelegate {
