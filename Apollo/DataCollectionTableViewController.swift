//
//  DataCollectionTableViewController.swift
//  Apollo
//
...
class DataCollectionTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.textLabel!.text = presenter.data[indexPath.row].key
        cell.detailTextLabel!.text = presenter.data[indexPath.row].value
